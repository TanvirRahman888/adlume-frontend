      ...
      <div className="mx-auto w-full max-w-360 px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            >
              Whether you need social media designs, ads, branding, websites, or
              landing pages, we can help your business look professional and
              grow online.
            </p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="https://wa.me/8801761784780?text=Hello%20Adlume%20Media%2C%20I%20want%20to%20start%20a%20new%20project."
                target="_blank"
