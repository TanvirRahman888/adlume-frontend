...
export default function ServiceDetailsCTA({ service }) {
  return (
      ...
      <div className="mx-auto w-full max-w-360 px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            >
              Tell us about your business and we will guide you with the right
              strategy, package, and next steps.
            </p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link
                href={`https://wa.me/8801761784780?text=${encodeURIComponent(
                  `Hello Adlume Media, I want to start with ${service.title}. Please share the details.`
                )}`}
                target="_blank"
