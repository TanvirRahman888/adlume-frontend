      ...
      <div className="mx-auto w-full max-w-360 px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            >
              Tell us about your business and we will suggest the right digital
              service plan for your goals.
            </p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="https://wa.me/8801761784780?text=Hello%20Adlume%20Media%2C%20I%20need%20help%20choosing%20the%20right%20service%20for%20my%20business."
                target="_blank"
