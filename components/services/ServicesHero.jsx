    ...
    <section className="relative overflow-hidden py-20 sm:py-24">
      ...
      <div className="relative mx-auto w-full max-w-360 px-4 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            From marketing strategy and social media management to paid ads,
            branding, websites, and lead generation, Adlume Media helps your
            brand get seen, clicked, and chosen.
          </p>
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="https://wa.me/8801761784780?text=Hello%20Adlume%20Media%2C%20I%20want%20to%20know%20more%20about%20your%20services."
              target="_blank"
